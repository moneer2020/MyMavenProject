...
import static com.hrms.utils.APICommonMethods.createEmployeeRequest;
import static com.hrms.utils.APICommonMethods.getOneEmployeeRequest;
...
//    String BaseURI = RestAssured.baseURI = "http://3.237.189.167/syntaxapi/api";
    ...
    public void a_request_is_prepared_to_create_an_employee() {
        request = createEmployeeRequest(GenerateTokenSteps.token,
                APIConstants.CREATE_EMPLOYEE_JSON);
    }
    ...
    public void the_employee_ID_is_stored_as_a_global_variable_to_be_used_for_other_calls(String jsonPathValue) {
        employeeID = response.jsonPath().getString(jsonPathValue);
    }

    @Given("a request is prepared to retrieve the created employee")
    public void a_request_is_prepared_to_retrieve_the_created_employee() {
        request = getOneEmployeeRequest(GenerateTokenSteps.token, employeeID);
    }
    ...
    public void the_retrieved_employee_ID_matches_the_globally_stored_employee_ID(String responseEmployeeID) {
    ...
    public void the_retrieved_data_at_matches_the_data_used_to_create_an_employee_with_employee_ID(
        ...
        /** Validating expected data that we stored in the feature file against actual
        * data that we are retrieving from the response. We are retrieving the response body
        * by calling the object in the feature file*/

        /** Retrieving expected data from the feature file*/
        List<Map<String, String>> expectedData = dataTable.asMaps(String.class, String.class);

        /** Retrieving actual data from the response object*/
